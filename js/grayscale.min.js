...
$(function() {
    $('#sel1').click(function() {
        ...
        $('#b1').css('z-index', '99');
/*
        $('#sel1').css('color', '#082e20');
*/
        $('#b2').css('z-index', '0');
/*
        $('#sel2').css('color', '#42DCA3');
*/
        $('#b3').css('z-index', '0');
/*
        $('#sel3').css('color', '#42DCA3');
*/
        $('#sel1').toggleClass("fun",true);
        $('#sel2').toggleClass("fun",false);
        $('#sel3').toggleClass("fun",false);
    });
});
$(function() {
    $('#sel2').click(function() {
        ...
        $('#b2').css('z-index', '99');
        $('#b3').css('z-index', '0');
        $('#sel1').toggleClass("fun",false);
        $('#sel2').toggleClass("fun",true);
        $('#sel3').toggleClass("fun",false);
    });
});
$(function() {
...
/*$(function() {
    $('#af3').hover(function() {
        $('#af3').css('z-index', '99');
        $('#a3').css('-webkit-filter', 'grayscale(0)');
        $('#a3').css('-webkit-transform', 'scale(1.01)');
        $('#af3').stop(true,false).animate({opacity:1.0},500)
    }, function() {
        // on mouseout, reset the background colour
        $('#af3').stop(true,false).animate({opacity:0.0},500, function() {
            $('#af3').css('z-index', '-1');
        })
    });
});*/
